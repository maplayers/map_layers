...
require 'map_layers/js_extensions/js_wrapper'
require 'map_layers/open_layers'
require 'map_layers/js_extensions/map'
require 'map_layers/js_extensions/map_handler'
require 'map_layers/js_extensions/map_builder'
